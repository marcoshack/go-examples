...
// NewPingServiceProtobufClient creates a Protobuf client that implements the PingService interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewPingServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) PingService {
...
func (c *pingServiceProtobufClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
...
func (c *pingServiceProtobufClient) callPing(ctx context.Context, in *PingRequest) (*PingResponse, error) {
...
// NewPingServiceJSONClient creates a JSON client that implements the PingService interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewPingServiceJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) PingService {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *pingServiceJSONClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "ping")
	ctx = ctxsetters.WithServiceName(ctx, "PingService")
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	caller := c.callPing
...
// NewPingServiceServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewPingServiceServer(svc PingService, opts ...interface{}) TwirpServer {
...
func (s *pingServiceServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *pingServiceServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// PingServicePathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const PingServicePathPrefix = "/twirp/ping.PingService/"

func (s *pingServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "ping")
	ctx = ctxsetters.WithServiceName(ctx, "PingService")
	...
	if pkgService != "ping.PingService" {
...
func (s *pingServiceServer) servePing(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *pingServiceServer) servePingJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
		...
		handler = func(ctx context.Context, req *PingRequest) (*PingResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.PingService.Ping(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*PingResponse)
...
func (s *pingServiceServer) servePingProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *pingServiceServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *pingServiceServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *pingServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "ping", "PingService")
}
