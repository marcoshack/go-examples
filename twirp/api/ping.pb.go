...
const file_ping_proto_rawDesc = "" +
	...
	"\vPingService\x12-\n" +
	"\x04Ping\x12\x11.ping.PingRequest\x1a\x12.ping.PingResponse\x123\n" +
	"\n" +
	"UnsafePing\x12\x11.ping.PingRequest\x1a\x12.ping.PingResponseB-Z+github.com/marcoshack/go-examples/twirp/apib\x06proto3"
...
var file_ping_proto_depIdxs = []int32{
	...
	0, // 1: ping.PingService.UnsafePing:input_type -> ping.PingRequest
	1, // 2: ping.PingService.Ping:output_type -> ping.PingResponse
	1, // 3: ping.PingService.UnsafePing:output_type -> ping.PingResponse
